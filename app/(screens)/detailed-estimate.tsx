      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.featureBoxes}>
          <View style={styles.featureBox}>
            <Ionicons name="shield-checkmark" size={28} color="#273054" />
            <Text style={styles.featureLabel}>Secure Pay</Text>
          </View>
          <View style={styles.featureBox}>
            <Ionicons name="checkmark-circle" size={28} color="#273054" />
            <Text style={styles.featureLabel}>AI Verified</Text>
          </View>
          <View style={styles.featureBox}>
            <Ionicons name="headset" size={28} color="#273054" />
...
const styles = StyleSheet.create({
  ...
  totalPrice: { fontSize: 28, fontWeight: '900', color: '#273054', marginTop: 6 },
  ...
  featureLabel: { color: '#273054', fontWeight: '700', marginTop: 8, fontSize: 13 },
  summaryText: { color: '#273054', fontSize: 14, lineHeight: 20 },
  ...
  totValue: { color: '#273054', fontWeight: '900', marginTop: 6 },
