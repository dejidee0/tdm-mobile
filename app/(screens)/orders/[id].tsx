...
const styles = StyleSheet.create({
  ...
  card: { flexDirection: 'row', alignItems: 'center', padding: 16, backgroundColor: '#D4AF37', borderRadius: 12, marginBottom: 20, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 6, shadowOffset: { width: 0, height: 2 }, elevation: 2 },
  thumb: { width: 90, height: 90, borderRadius: 10, backgroundColor: '#f5f5f5' },
  cardInfo: { flex: 1, marginLeft: 14, gap: 4 },
  cardTitle: { fontWeight: '600', fontSize: 15, color: '#fff' },
