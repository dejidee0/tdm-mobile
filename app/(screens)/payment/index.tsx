...
const styles = StyleSheet.create({
  ...
  cardPrice: { fontWeight: '900', fontSize: 14, color: '#273054' },
  ...
  label: { fontSize: 13, fontWeight: '600', color: '#273054', marginBottom: 8 },
  input: { height: 44, backgroundColor: '#f5f5f5', borderRadius: 10, paddingHorizontal: 12, fontSize: 14, color: '#273054', borderWidth: 1, borderColor: '#f0f0f0' },
  inputFocused: { borderColor: '#273054', borderWidth: 2, backgroundColor: '#fff' },
  payBtn: { height: 48, borderRadius: 10, backgroundColor: '#273054', alignItems: 'center', justifyContent: 'center', shadowColor: '#273054', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.15, shadowRadius: 8, elevation: 5 },
