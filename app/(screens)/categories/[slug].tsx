            ...
            renderItem={({ item }) => (
              <View style={styles.productCard}>
                ...
                <TouchableOpacity style={styles.heart} onPress={() => toggleSaved(item.id)}>
                  <Ionicons name={isSaved(item.id) ? "heart" : "heart-outline"} size={20} color={isSaved(item.id) ? "#e24a43" : "#D4AF37"} />
                </TouchableOpacity>
              </View>
            )}
          />
...
const styles = StyleSheet.create({
  ...
  productPrice: { fontWeight: '900', fontSize: 14, color: '#D4AF37', paddingHorizontal: 10, paddingBottom: 10 },
