...
const styles = StyleSheet.create({
  ...
  cardName: { fontWeight: '600', fontSize: 15, color: '#222a44', marginBottom: 6 },
  ...
  addBtnText: { color: '#222a44', fontWeight: '600', fontSize: 15 },
});
